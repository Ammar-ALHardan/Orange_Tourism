        ...
        <div class="tm-page-wrap mx-auto">
            ...
            <div class="tm-container-outer" id="tm-section-2">
                <section class="tm-slideshow-section">
                    <div class="tm-slideshow">
                        ...
                        <img src="img/wa.png" alt="Image" width="100%">
                ...
                <section class="clearfix tm-slideshow-section tm-slideshow-section-reverse">
                    ...
                    <div class="tm-right tm-slideshow tm-slideshow-highlight">
                        ...
                        <img src="img/waa.jpg" alt="Image" width="100%">
                ...
                <section class="tm-slideshow-section">
                    <div class="tm-slideshow">
                        ...
                        <img src="img/petra.jpg" alt="Image" width="100%">
            ...
            <div class="tm-container-outer" id="tm-section-3">
                ...
                <div class="tab-content clearfix">
                    ...
                    <!-- Tab 1 -->
                    <!-- <?php 
                                    // $query = "SELECT * FROM `address` inner join category on category.address_id=address.id inner join tourist_place on tourist_place.category_id=category.id";
                        ...
                        <div class="tm-recommended-place-wrap">
                            <div class="tm-recommended-place">
                                ...
                                <div class="tm-recommended-description-box">
                                    <h3 class="tm-recommended-title"><?php // echo $row['address'] ?></h3>
            ...
            <footer class="tm-container-outer">
                <p class="mb-0">Copyright © <span class="tm-current-year">2021</span> Your Company 
                    
                . Designed by <a rel="nofollow" href="#" target="_parent">Orange</a></p>
            </footer>
        </div>
    </div> <!-- .main-content -->
