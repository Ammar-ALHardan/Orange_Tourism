...
if(isset($_POST['addBtn'])){
    ...
    $image   =time().'1'. $_FILES['img']['name'];
    $tmp     = $_FILES['img']['tmp_name'];
    $path    = 'uploads/';
    
    $query = "INSERT INTO tourist_place (`nameplace`,`description`,`img`,`lat`,`lon`,`city_id`) VALUES ('$nameplace','$description','$image','$lat','$lon','$city_id')";
